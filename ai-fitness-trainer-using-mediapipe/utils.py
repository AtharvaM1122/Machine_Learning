...
# ✅ Modified `get_landmark_features()` to include bicep curl keypoints
def get_landmark_features(kp_results, dict_features, feature, frame_width, frame_height):
    ...
    if feature == 'nose':
        ...
        # ✅ Added bicep curl keypoints
        bicep_elbow_coord = get_landmark_array(kp_results, dict_features[feature]['bicep_elbow'], frame_width, frame_height)
        bicep_wrist_coord = get_landmark_array(kp_results, dict_features[feature]['bicep_wrist'], frame_width, frame_height)

        return shldr_coord, elbow_coord, wrist_coord, hip_coord, knee_coord, ankle_coord, foot_coord, bicep_elbow_coord, bicep_wrist_coord
